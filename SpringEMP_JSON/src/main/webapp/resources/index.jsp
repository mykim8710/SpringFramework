							...
							<div class="panel panel-default">
									...
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian"
											href="#sportswear"> <span class="badge pull-right"><i
												class="fa fa-plus"></i></span> DEPT Table
										</a>
									</h4>
								</div>
								...
								<div id="sportswear" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<c:forEach items="${deptList}" var="colName">
												<li><a href="#">${colName.colName}</a></li>
											</c:forEach>
										</ul>
									</div>
								</div>
								...
								<div class="product-image-wrapper">
									...
									<div class="single-products">
										<div class="productinfo text-center">
											<img src="images/home/product${dto.itemNo}.jpg" alt="" />		
											<h2>&#8361;${dto.itemPrice}</h2>
											<p>${dto.itemName}</p>
											<a href="select.do?itemNo=${dto.itemNo}" class="btn btn-default add-to-cart"><i
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>&#8361;${dto.itemPrice}</h2>
												<p>${dto.itemName}</p>
												<a href="select.do?itemNo=${dto.itemNo}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
									...
									<div class="choose">
										<ul class="nav nav-pills nav-justified">
											<li><a href="select.do?itemNo=${dto.itemNo}"><i class="fa fa-plus-square"></i>Add to wishlist</a></li>
											<li><a href="select.do?itemNo=${dto.itemNo}"><i class="fa fa-plus-square"></i>Add to compare</a></li>
										</ul>
									</div>
